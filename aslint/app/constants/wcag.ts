...
import { IWcagSuccessCriteria } from '../interfaces/audit-rule.interface';
...
export const WCAG: Readonly<{ [key: string]: any }> = Object.freeze({
  1: {
    1.1: {
      handle: 'Text Alternatives',
...
export class Wcag {
  ...
  public static getSuccessCriteria(numId: string): IWcagSuccessCriteria {
    function _find(collection: any, key: string, value: string) {
    ...
    return _find(wcag.principles, 'num', numId);
  }

  public static getWcagTechniqueDetails(level: string, techniqueId: string): { id: string, title: string } {
    const findByTechniqueId = (obj: any): any => {
      let result: any = null;
    ...
    const successCriteria: IWcagSuccessCriteria = Wcag.getSuccessCriteria(level);
