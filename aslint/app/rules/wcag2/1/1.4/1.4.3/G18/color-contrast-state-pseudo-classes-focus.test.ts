import { ColorContrastStatePseudoClassesFocus } from './color-contrast-state-pseudo-classes-focus';
...
describe('Rules', () => {
  ...
  describe('ColorContrastStatePseudoClassesFocus#', () => {

    let fakeDom: Element;

    new ColorContrastStatePseudoClassesFocus().registerValidator();
    ...
    it('should not pass contrast ratio at least 4.5:1 for text less than 18pt, not bold', async () => {
      ...
      const rule: ColorContrastStatePseudoClassesFocus = new ColorContrastStatePseudoClassesFocus();

      await rule.run(fakeDom);

      expect(Object.keys(Validator.getReports()).length).toBe(1);
      expect(Validator.getReport('report_0').message).toBe(TranslateService.instant('color_contrast_state_pseudo_classes_report_message_4', ['focus', '4.48', '#ffffff', '#777777', '15', fontWeight, '']));
      expect(Validator.getReport('report_0').node.nodeName.toLowerCase()).toBe('p');
      expect(Validator.getReport('report_0').ruleId).toBe('color-contrast-state-pseudo-classes-focus');
    ...
    it('should not pass contrast ratio at least 4.5:1 for text less than 14pt, bold', async () => {
      ...
      expect(Object.keys(Validator.getReports()).length).toBe(1);
      expect(Validator.getReport('report_0').message).toBe(TranslateService.instant('color_contrast_state_pseudo_classes_report_message_4', ['focus', '4.48', '#ffffff', '#777777', '13', fontWeight, '']));
      expect(Validator.getReport('report_0').node.nodeName.toLowerCase()).toBe('p');
      expect(Validator.getReport('report_0').ruleId).toBe('color-contrast-state-pseudo-classes-focus');
    ...
    it('should not pass contrast ratio at least 3:1 for text at least 18pt, not bold', async () => {
      ...
      expect(Object.keys(Validator.getReports()).length).toBe(1);
      expect(Validator.getReport('report_0').message).toBe(TranslateService.instant('color_contrast_state_pseudo_classes_report_message_3', ['focus', '2.85', '#ffffff', '#999999', '18', fontWeight, '']));
      expect(Validator.getReport('report_0').node.nodeName.toLowerCase()).toBe('p');
      expect(Validator.getReport('report_0').ruleId).toBe('color-contrast-state-pseudo-classes-focus');
    ...
    it('should not pass contrast ratio at least 3:1 for text at least 40px (~30pt), not bold', async () => {
      ...
      expect(Object.keys(Validator.getReports()).length).toBe(1);
      expect(Validator.getReport('report_0').message).toBe(TranslateService.instant('color_contrast_state_pseudo_classes_report_message_3', ['focus', '2.85', '#ffffff', '#999999', '30', fontWeight, '']));
      expect(Validator.getReport('report_0').node.nodeName.toLowerCase()).toBe('p');
      expect(Validator.getReport('report_0').ruleId).toBe('color-contrast-state-pseudo-classes-focus');
    ...
    it('should not pass contrast ratio at least 3:1 for text at least 13pt, bold', async () => {
      ...
      expect(Object.keys(Validator.getReports()).length).toBe(1);
      expect(Validator.getReport('report_0').message).toBe(TranslateService.instant('color_contrast_state_pseudo_classes_report_message_4', ['focus', '2.85', '#ffffff', '#999999', '13', fontWeight, '']));
      expect(Validator.getReport('report_0').node.nodeName.toLowerCase()).toBe('p');
      expect(Validator.getReport('report_0').ruleId).toBe('color-contrast-state-pseudo-classes-focus');
