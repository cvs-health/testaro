  ...
  if (Array.isArray(acts)) {
    ...
    tests.forEach(test => {
      ...
      if (which === 'axe') {
        ...
        if (facts) {
          rules.embAc = 'multiply link- or button-contained links, buttons, inputs, and selects by 5';
          deficit.embAc = 5 * (facts.links + facts.buttons + facts.inputs + facts.selects);
        }
        else {
